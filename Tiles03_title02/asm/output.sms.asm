...
; Data from 24F to 34A6 (12888 bytes)
...
; Data from 34FB to 350D (19 bytes)
...
; Data from 353E to 355B (30 bytes)
...
; Data from 35B5 to 35C8 (20 bytes)
...
_LABEL_35EC_74:
	outi
	jr   nz, _LABEL_35EC_74
	ret


; Data from 35F1 to 3608 (24 bytes)
...
; Data from 360F to 3663 (85 bytes)
...
; Data from 36AC to 3708 (93 bytes)
...
; Data from 370F to 3736 (40 bytes)
...
; Data from 393A to 393B (2 bytes)
.db $18, $06
...
_LABEL_3A31_49:
	...
	inc  hl
	dec  c
	jr   nz, _LABEL_3A2E_50
	pop  bc
	dec  bc
	ld   a, b
	or   c
	jp   nz, _LABEL_3986_51
	ret


; Data from 3A44 to 3A4B (8 bytes)
